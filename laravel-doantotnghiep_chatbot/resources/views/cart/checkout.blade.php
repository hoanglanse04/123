            ...
            <div class="grid grid-cols-12 gap-4">
                                ...
                                <article class="flex items-center justify-between mb-4 cart-row">
                                    <div class="flex w-full">
                                        <div class="w-20 h-20 rounded-lg overflow-hidden" style="min-width: 80px">
                                            <img class="object-cover" src="{{ image($item->associatedModel->image) }}" alt="{{ $item->name }}">
                                        </div>
                                        <div class="ml-4">
                ...
                <div class="md:col-span-5 col-span-12">
                    ...
                    <div class="rounded-lg bg-white p-4 mb-4">
                        ...
                        <textarea name="note" id="note" form="order-cart" placeholder="Ghi chú đơn hàng" class="w-full text-sm h-24 border-2 border-solid border-gray-200 rounded-lg mt-4"></textarea>
                    ...
                    <div class="rounded-lg bg-white p-4">
                        ...
                        <ul class="py-4">
                            ...
                            <li class="flex items-center justify-between py-2">
                                ...
                                <div>
                                    <b class="cart-total-price">{{ number_format(Cart::getTotal(), 0, ',', '.') }}</b><b>đ</b>
                                </div>
                            </li>
                        </ul>
                        <button type="submit" form="order-cart"  class="w-full block px-4 py-3 rounded-lg font-semibold transition text-gray-50 text-center uppercase"style="background: linear-gradient(0deg, rgb(255 61 44 / 78%) 0%, rgb(255 131 87) 100%)"> Đặt hàng </button>
                    </div>
