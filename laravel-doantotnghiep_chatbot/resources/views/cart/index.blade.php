                ...
                <div class="grid grid-cols-12 gap-4">
                            ...
                            @foreach ($cartItems as $row)
                                <article class="flex sm:flex-row flex-col justify-between mb-4 cart-row space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        <div>
                                            <div class="quantity flex h-10 rounded-md overflow-hidden border border-solid border-gray-200 md:mx-2" data-productid="{{ $row->id }}">
                                                <input type="button" onclick="changeQuantity(this, -1)" value="-" class="w-8 h-10 cursor-pointer font-semibold hover:bg-gray-300 transition">
                                                <input class="cart-quantity-input text-center w-8 h-10"
                                                    name="quantity"
                                                    value="{{ $row->qty }}"
                                        ...
                                        <a href="" class="confirmation w-6 h-6 block">
                                            <svg class="w-full h-full fill-current text-[#c7a97f]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"><path d="M7.9785156 5.9804688 A 2.0002 2.0002 0 0 0 6.5859375 9.4140625L12.171875 15L6.5859375 20.585938 A 2.0002 2.0002 0 1 0 9.4140625 23.414062L15 17.828125L20.585938 23.414062 A 2.0002 2.0002 0 1 0 23.414062 20.585938L17.828125 15L23.414062 9.4140625 A 2.0002 2.0002 0 0 0 21.960938 5.9804688 A 2.0002 2.0002 0 0 0 20.585938 6.5859375L15 12.171875L9.4140625 6.5859375 A 2.0002 2.0002 0 0 0 7.9785156 5.9804688 z" /></svg>
                                        </a>
                                    </div>
                                </article>
                            @endforeach
                    ...
                    <div class="lg:col-span-5 col-span-12 pt-4">
                        <div class="rounded-lg bg-gray-50 p-4">
                            ...
                            <a href="{{ route('cart.checkout') }}" class="block px-4 py-3 rounded-lg font-semibold bg-[#c7a97f] transition text-gray-50 text-center uppercase"> Thanh toán </a>
                        </div>
                    </div>
                </div>
            @else
